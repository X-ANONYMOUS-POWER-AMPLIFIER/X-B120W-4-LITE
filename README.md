...
X-B120W-4-LITE is a power amplifier main-circuit module designed to be simple, with only few number of transistors within its input-stage and its VAS, designed to be fit with a small size single-sided circuit board. It is designed to handle 120 watt of 4-ohms output load power rating.
